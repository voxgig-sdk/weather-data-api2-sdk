...
func (sdk *WeatherDataApi2SDK) OptionsMap() map[string]any {
...
func (sdk *WeatherDataApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WeatherDataApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WeatherDataApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WeatherDataApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WeatherDataApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WeatherDataApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WeatherDataApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WeatherDataApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WeatherDataApi2SDK {
	...
	sdk := NewWeatherDataApi2SDK(sdkopts)
	sdk.Mode = "test"
