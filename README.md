...
This API provides weather data, including current conditions, forecasts, and historical weather information.

Learn more about Weather Data API at [openweathermap.org](https://openweathermap.org).
...
const items = await client.Weather().list({ appid: "example" })
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/weather-data-api2-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/weather-data-api2-sdk/releases) |
| Python | `voxgig-sdk-weather-data-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/weather-data-api2-sdk/releases) |
| PHP | `voxgig-sdk/weather-data-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/weather-data-api2-sdk/releases) |
| Golang | `github.com/voxgig-sdk/weather-data-api2-sdk/go` | `go get github.com/voxgig-sdk/weather-data-api2-sdk/go@latest` |
| Ruby | `voxgig-sdk-weather-data-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/weather-data-api2-sdk/releases) |
| Lua | `voxgig-sdk-weather-data-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/weather-data-api2-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/weather-data-api2-sdk/go-cli` | `go install github.com/voxgig-sdk/weather-data-api2-sdk/go-cli/cmd/weather-data-api2@latest` |
| Go MCP server | `github.com/voxgig-sdk/weather-data-api2-sdk/go-mcp` | `go get github.com/voxgig-sdk/weather-data-api2-sdk/go-mcp@latest` |
...
$weathers = $client->Weather()->list();
print_r(array_map(fn($item) => $item->data_get(), $weathers));
```
