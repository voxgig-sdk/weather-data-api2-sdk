...
#      offline in seeded test mode (WeatherDataApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WeatherDataApi2_sdk.rb")
  SDK_CLASS = "WeatherDataApi2SDK"
