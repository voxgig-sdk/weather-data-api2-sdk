...
class WeatherEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WEATHER_DATA_API2_TEST_WEATHER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def weather_basic_setup(extra)
  ...
  entid_env_raw = ENV["WEATHER_DATA_API2_TEST_WEATHER_ENTID"]
