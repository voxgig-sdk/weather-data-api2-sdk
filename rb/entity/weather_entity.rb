# WeatherDataApi2 SDK Weather entity
...
class WeatherEntity
  ...
  def data_set(args)
    if args
      @_data = WeatherDataApi2Helpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = WeatherDataApi2Helpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Weather>, Array] the matching Weather items; raises WeatherDataApi2Error on failure
