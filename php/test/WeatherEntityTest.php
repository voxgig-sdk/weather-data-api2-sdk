...
class WeatherEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $cfg = WeatherDataApi2Config::shared_config();
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEATHER_DATA_API2_TEST_WEATHER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function weather_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEATHER_DATA_API2_TEST_WEATHER_ENTID");
    ...
    if ($env["WEATHER_DATA_API2_TEST_LIVE"] === "TRUE") {
