...
// WeatherDataApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeatherDataApi2SDK::test)
...
{
    private const SDK_CLASS = 'WeatherDataApi2SDK';
    ...
    private const SDK_BASE = 'weatherdataapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../weatherdataapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
