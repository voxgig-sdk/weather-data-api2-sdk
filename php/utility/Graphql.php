...
// WeatherDataApi2 SDK utility: graphql
//
...
class WeatherDataApi2Graphql
{
    ...
    // equivalent.
    public static function body(WeatherDataApi2Context $ctx): mixed
    {
    ...
    public static function errors(WeatherDataApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
