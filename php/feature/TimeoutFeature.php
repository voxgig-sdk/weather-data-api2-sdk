...
// WeatherDataApi2 SDK timeout feature
...
class WeatherDataApi2TimeoutFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _with_timeout(WeatherDataApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeatherDataApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
