...
// WeatherDataApi2 SDK rbac feature
...
class WeatherDataApi2RbacFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _required(WeatherDataApi2Context $ctx): ?string
    {
    ...
    private function _reject(WeatherDataApi2Context $ctx, string $required): void
    {
    ...
    private function _track(WeatherDataApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
