...
AQL-driven CLI and REPL for the WeatherDataApi2 SDK. Positional arguments are
...
```sh
go build -o weather-data-api2-cli ./...
```
...
./weather-data-api2-cli load 1 weather
./weather-data-api2-cli load '{id:1}' weather
