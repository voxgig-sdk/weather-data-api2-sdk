...
func registerSDKWords(r *eng.Registry, client *sdk.WeatherDataApi2SDK) {
...
func runOp(client *sdk.WeatherDataApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
