// Command WeatherDataApi2-cli is a CLI + REPL for the WeatherDataApi2 SDK,
...
const prompt = "weather-data-api2"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WEATHER_DATA_API2_APIKEY (api key), WEATHER_DATA_API2_BASE (base url override)")
