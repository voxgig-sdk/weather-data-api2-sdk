...
func registerTools(server *mcp.Server, client *sdk.WeatherDataApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data-api2_list",
		Description: "List records from WeatherDataApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data-api2_load",
		Description: "Load a single record from WeatherDataApi2. " +
...
func runOp(client *sdk.WeatherDataApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeatherDataApi2SDK, name string) (sdk.WeatherDataApi2Entity, error) {
