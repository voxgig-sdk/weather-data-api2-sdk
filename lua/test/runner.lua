...
function runner.env_override(m)
  local live = runner.getenv("WEATHERDATAAPI2_TEST_LIVE")
  local override = runner.getenv("WEATHERDATAAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WEATHERDATAAPI2_TEST_EXPLAIN")
