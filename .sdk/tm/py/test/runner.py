...
class WeatherDataApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeatherDataApi2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WeatherDataApi2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WeatherDataApi2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
