...
// WeatherDataApi2 SDK utility: fetcher

class WeatherDataApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeatherDataApi2SDK/1.0)';
    ...
    public static function call(WeatherDataApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
