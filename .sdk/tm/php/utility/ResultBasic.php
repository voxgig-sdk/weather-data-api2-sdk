...
// WeatherDataApi2 SDK utility: result_basic

class WeatherDataApi2ResultBasic
{
    public static function call(WeatherDataApi2Context $ctx): ?WeatherDataApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WeatherDataApi2Error) ? $result->err->msg : (string)$result->err;
