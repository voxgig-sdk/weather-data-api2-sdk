...
// WeatherDataApi2 SDK utility: make_options

class WeatherDataApi2MakeOptions
{
    ...
    public static function call(WeatherDataApi2Context $ctx): array
    {
        ...
        //
        // `WeatherDataApi2Schema::optspec()` is built from the model:
        ...
        $optspec = WeatherDataApi2Schema::optspec();
