...
// WeatherDataApi2 SDK audit feature
...
class WeatherDataApi2AuditFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _emit(WeatherDataApi2Context $ctx, string $outcome): void
    {
