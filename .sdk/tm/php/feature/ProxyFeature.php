...
// WeatherDataApi2 SDK proxy feature
...
class WeatherDataApi2ProxyFeature extends WeatherDataApi2BaseFeature
{
    ...
    public function init(WeatherDataApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherDataApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
