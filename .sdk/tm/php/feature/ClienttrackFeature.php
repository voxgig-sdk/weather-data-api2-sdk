...
// WeatherDataApi2 SDK clienttrack feature
...
class WeatherDataApi2ClienttrackFeature extends WeatherDataApi2BaseFeature
{
    ...
    public function PostConstruct(WeatherDataApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeatherDataApi2-SDK';
