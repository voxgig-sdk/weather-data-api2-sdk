...
// WeatherDataApi2 SDK ratelimit feature
...
class WeatherDataApi2RatelimitFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _acquire(WeatherDataApi2Context $ctx): void
    {
    ...
    private function _track(WeatherDataApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
