...
// WeatherDataApi2 SDK cache feature
...
class WeatherDataApi2CacheFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _through(WeatherDataApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
