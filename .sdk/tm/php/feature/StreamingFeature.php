...
// WeatherDataApi2 SDK streaming feature
...
class WeatherDataApi2StreamingFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _iterate(WeatherDataApi2Result $result): \Generator
    {
    ...
    private function _streamable(WeatherDataApi2Context $ctx): bool
    {
