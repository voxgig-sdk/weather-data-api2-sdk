...
// WeatherDataApi2 SDK netsim feature
...
class WeatherDataApi2NetsimFeature extends WeatherDataApi2BaseFeature
{
    ...
    private function _simulate(WeatherDataApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeatherDataApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
