...
// WeatherDataApi2 SDK retry feature
...
class WeatherDataApi2RetryFeature extends WeatherDataApi2BaseFeature
{
    ...
    public function init(WeatherDataApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherDataApi2Context $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(WeatherDataApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(WeatherDataApi2Context $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
