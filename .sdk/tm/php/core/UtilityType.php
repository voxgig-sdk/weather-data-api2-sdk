...
// WeatherDataApi2 SDK utility type

class WeatherDataApi2Utility
{
    ...
    public static function copy(WeatherDataApi2Utility $src): WeatherDataApi2Utility
    {
        $u = new WeatherDataApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
