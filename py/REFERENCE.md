# WeatherDataApi2 Python SDK Reference

Complete API reference for the WeatherDataApi2 Python SDK.
...
#### `WeatherDataApi2SDK.test(testopts=None, sdkopts=None)`
...
```python
results = client.Weather().list({"appid": "example"})
