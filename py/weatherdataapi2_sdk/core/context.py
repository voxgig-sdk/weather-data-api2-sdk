...
from weatherdataapi2_sdk.core.control import WeatherDataApi2Control
...
from weatherdataapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class WeatherDataApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WeatherDataApi2Control()
        ...
        if isinstance(sp, WeatherDataApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WeatherDataApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WeatherDataApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WeatherDataApi2Operation({})
    ...
    def make_error(self, code, msg):
        return WeatherDataApi2Error(code, msg, self)
