...
from weatherdataapi2_sdk.utility import register

# Load features
from weatherdataapi2_sdk.feature.base_feature import WeatherDataApi2BaseFeature
from weatherdataapi2_sdk.features import _has_feature, _make_feature
...
class WeatherDataApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WeatherDataApi2Utility()
        self._utility = utility

        from weatherdataapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return WeatherDataApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeatherDataApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Weather(self, data=None) -> "WeatherEntity":
        ...
        from weatherdataapi2_sdk.entity.weather_entity import WeatherEntity
        return WeatherEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "WeatherDataApi2SDK":
        if sdkopts is None:
            sdkopts = {}
