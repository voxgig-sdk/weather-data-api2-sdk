...
from weatherdataapi2_sdk.utility.voxgig_struct import voxgig_struct as vs
from weatherdataapi2_sdk import WeatherDataApi2SDK
from weatherdataapi2_sdk.core.spec import WeatherDataApi2Spec
from weatherdataapi2_sdk.core.result import WeatherDataApi2Result
from weatherdataapi2_sdk.core.response import WeatherDataApi2Response
from weatherdataapi2_sdk.core.operation import WeatherDataApi2Operation
from weatherdataapi2_sdk.core.error import WeatherDataApi2Error
from weatherdataapi2_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return WeatherDataApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except WeatherDataApi2Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = WeatherDataApi2Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = WeatherDataApi2SDK.test(None, None)
        ...
        class TestInitFeature(WeatherDataApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WeatherDataApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = WeatherDataApi2SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = WeatherDataApi2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WeatherDataApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WeatherDataApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = WeatherDataApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WeatherDataApi2SDK.test(None, setup_opts)
