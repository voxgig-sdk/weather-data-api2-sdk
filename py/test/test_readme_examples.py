# WeatherDataApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeatherDataApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeatherDataApi2SDK(...) and WeatherDataApi2SDK.test(...) become
#      WeatherDataApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weatherdataapi2_sdk"
_SDK_CLASS = "WeatherDataApi2SDK"
