...
(0, node_test_1.describe)('WeatherDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WeatherDataApi2SDK({
...
function liveScenariosActive() { return false && process.env.WEATHER_DATA_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WeatherDataApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.WEATHER_DATA_API2_APIKEY,
        }));
        let idmap = env['WEATHER_DATA_API2_TEST_WEATHER_ENTID'];
    ...
    const client = new __1.WeatherDataApi2SDK({
        base: 'http://localhost:8080',
