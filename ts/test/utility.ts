...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WEATHERDATAAPI2_TEST_LIVE ||
    'TRUE' === process.env.WEATHERDATAAPI2_TEST_OVERRIDE
  ) {
  ...
  m.WEATHERDATAAPI2_TEST_EXPLAIN = process.env.WEATHERDATAAPI2_TEST_EXPLAIN || m.WEATHERDATAAPI2_TEST_EXPLAIN
